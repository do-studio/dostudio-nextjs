    ...
    <div className="w-full mx-auto">
      {faqs1.map((faq, index) => (
        <div key={index} className="mb-2">
          <button
            className={`w-full text-left p-4 bg-gray-100 ${activeIndex1 === index && "bg-primarygreen"
          ...
          <div
            className={`overflow-hidden transition-[max-height] duration-500 ease-in-out ${activeIndex1 === index ? "max-h-[200px]" : "max-h-0"
              }`}
          >
    ...
    <>
      <div className="w-full mx-auto">
        {faqs2.map((faq, index) => (
          <div key={index} className="mb-2">
            <button
              className={`w-full text-left p-4 bg-gray-100 ${activeIndex2 === index && "bg-primarygreen"
                } transition-all duration-200  rounded-xl  flex justify-between items-center`}
            ...
            <div
              className={`overflow-hidden transition-[max-height] duration-500 ease-in-out ${activeIndex2 === index ? "max-h-[200px]" : "max-h-0"
                }`}
            >
              <div className="p-4 bg-white text-sm border rounded-xl mt-2">
                <p>{faq.answer}</p>
    ...
    <div className="w-full mx-auto">
      {faqs2.slice(0, showAll ? faqs2.length : 4).map((faq, index) => (
        <div key={index} className="my-2 border-b last:border-b-0 outline-none">
          <button
            className={`w-full text-left pl-0 p-4 bg-white ${activeFaq === index && "bg-primarygreen"
          ...
          <div
            className={`overflow-hidden transition-[max-height] duration-500 ease-in-out ${activeFaq === index ? "max-h-[200px]" : "max-h-0"
              }`}
          >
