...
import { wrk1, wrk2, wrk3, wrk4, wrk5 ,WRK1,WRK2,serbra1,serbra2,serdig1,serdig2} from "../../../../../public/images/index";
...
async function fetchData() {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/creatives?&populate=*`,
      { cache: "no-store"}
    );
...
const Page = () => {
    ...
    return (
       <>
        <Head>
             <link rel="canonical" href="https://dostudio.co.in/services/digital-marketing-agency-in-calicut" key="canonical"/>
        </Head>
                            ...
                            <FadeUp duration={0.5} delay={0.5}>
                                <div className='relative group'>
                                    <div className='relative aspect-square w-full'>
                                        <Image loading='lazy' src={data.attributes.image.data.attributes.url} fill={true} className='object-cover' alt="wrk1"/>
                                    </div>
                                </div>
                            </FadeUp>
