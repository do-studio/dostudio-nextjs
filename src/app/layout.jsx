...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://cdn.sanity.io/images/0hjyj1bs/production/88a820889366024cefb0e05045fc37dadc7e7d1f-333x197.svg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Digital Marketing and Branding agency in Calicut, Kerala...",
    images: [
      "https://cdn.sanity.io/images/0hjyj1bs/production/88a820889366024cefb0e05045fc37dadc7e7d1f-333x197.svg",
    ],
  },
  other: {
    "google-site-verification": "K-0KPQ78AmDrdt3Dtqtln-KygEAHUAR0c5Qo_m4cZkU",
    "pixel:payload": "TEST88229",
    "facebook-domain-verification": "9q6jpn3s5dw615nx4zydgv6qsmkp6q",
      ...
      <body className={poppins.className}>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1141424740995604&ev=PageView&noscript=1"
            alt="Facebook Pixel"
          />
        </noscript>
